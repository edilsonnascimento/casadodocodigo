...
<title>Seu carrinho de compras - Casa do CÃ³digo</title>
    ...
    <meta property="og:image" content="//cdn.shopify.com/s/files/1/0155/7645/t/232/assets/logo-social.jpg?5355844097266431448" />
	...
	<meta itemprop="image" content="//cdn.shopify.com/s/files/1/0155/7645/t/232/assets/casa-do-codigo.svg?5355844097266431448">
	...
	<meta id="in-context-paypal-metadata" data-shop-id="1557645" data-environment="production" data-locale="pt_BR" data-paypal-v4="true" data-currency="BRL">
    ...
    <script id="shopify-features" type="application/json">{"accessToken":"3bbd6d004165f9ffd785ab71b162a043","betas":[],"domain":"www.casadocodigo.com.br","shopId":1557645,"smart_payment_buttons_url":"https:\/\/cdn.shopifycloud.com\/payment-sheet\/assets\/latest\/spb.pt-br.js"}</script>
			...
			<nav role="navigation" aria-label="Categorias de livros" class="colecoesDaCDC">
					<li class="colecoesDaCDC-colecaoItem">
						...
						<nav class="colecoesDaCDC-colecaoItem-subColecoes">
								<li class="colecaoItem-subColecoes-item">
									<a href="/collections/programacao-logica">LÃ³gica</a>
								</li>
								<li class="colecaoItem-subColecoes-item">
					...
					<li class="colecoesDaCDC-colecaoItem">
						...
						<nav class="colecoesDaCDC-colecaoItem-subColecoes">
								...
								<li class="colecaoItem-subColecoes-item">
									<a href="/collections/business-gestao">GestÃ£o</a>
								</li>
								<li class="colecaoItem-subColecoes-item">
		...
		<a tabindex="3" href="${s:mvcUrl('CCC#itens').build()}" title="Ir para sacola de compras" class="sacola cabecalhoPrincipal-itemNavegacao">
			<svg width="60px" height="24px" viewBox="0 0 60 24" role="img" aria-labelledby="sacolaLabel" class="sacola-icone">
				<title id="sacolaLabel">
					VocÃª tem ${carrinhoCompras.quantidade} itens na sacola
				</title>
	...
	<form role="search"
		...
		<fieldset class="buscaDoRodape-fieldset">
			...
			<input id="campoBuscaRodape"
				   ...
				   placeholder="Busque por autor, tÃ­tulo, conteÃºdo..."
				   type="search"
				   name="q"
				   required
				   aria-required
	...
	<div class="container" role="presentation">
		<div class="rodape-conteudo" role="presentation">
		 ...
		 --><section class="rodape-secao rodape-secaoOutros">
				<h3 class="rodape-titulo">Receba novidades e lanÃ§amentos</h3>
					...
					<ul class="grupoCaelum-column-list">
						...
						<li class="column-item">
							<a href="http://www.casadocodigo.com.br">
								<img class="column-item-logo" src="//cdn.shopify.com/s/files/1/0155/7645/t/232/assets/footer-icon-cdc.svg?5355844097266431448"><span class="column-item-title">Casa do CÃ³digo</span>					
							</a>
						</li>
					</ul>
				</li>
					...
					<ul class="grupoCaelum-column-list">
						...
						<li class="column-item">
							<a href="http://www.aluralingua.com.br">
								<img class="column-item-logo" src="//cdn.shopify.com/s/files/1/0155/7645/t/232/assets/footer-icon-aluralingua.svg?5355844097266431448"><span class="column-item-title">Alura LÃ­ngua</span>
							</a>
						</li>
					</ul>
				</li>
